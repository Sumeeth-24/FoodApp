...
const Login = () => {
  ...
  return (
    ...
    />
      ...
      {/* Content Box */}
      <div className="flex flex-col items-center bg-lightOverlay w-[60%] md:w-508 h-full
       z-10 backdrop-blur-md p-4 px-4
        py-12 gap-6
         ">
          {/* Top Logo section */}
              ...
              <p>
                ...
                <motion.button {...buttonClick} className="text-red-400 underline cursor-pointer bg-transparent" onClick={() => setIsSignUp(true)}>
                  ...
                  <p>
                   ...
                   {/* Button section */}
                   {isSignUp ? ( 
                   <motion.button {...buttonClick} className="w-full px-4 py-2 rounded-md bg-red-400 cursor-pointer text-white text-xl
                     capitalize hover:bg-red-500 transition-all duration-150 "
